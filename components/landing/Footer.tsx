      ...
      <div className="mx-auto w-full max-w-screen-xl px-8 sm:px-8 py-6 lg:py-8">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          <div className="flex flex-col items-start">
            ...
            >
              <Image src={Logo1} alt=" Logo" height={88} width={88} />
            </Link>
            <div className="flex flex-row items-center gap-3 mb-4">
              ...
              />
              <Link
                href="mailto:jsong@aibuildiq.me"
        ...
        <div className="flex sm:flex-row flex-col sm:items-center sm:justify-between sm:gap-0 gap-2">
          <span className="text-sm text-center font-clash-display"> Copyright 2024 aibuildiq.com all rights reserved</span>{" "}
          <span className="text-sm text-black sm:text-center dark:text-white text-center font-clash-display">
          Crafted with passion by {" "}
            <Link className="font-bold" target="_blank" href="">Vhann</Link>
          </span>
        </div>
      </div>
    </footer>
